...
#ifdef CONFIG_TIVO
/* The 3.3 netdevice.h has all this: */
#else
...
/* RHEL5.6 has defined these 2 functions */
#if ( (!defined(RHEL_MINOR)) || ((RHEL_MAJOR <= 5) && (RHEL_MINOR < 6)) )
...
/* RHEL5.6 has defined this structure type */
#if ( (!defined(RHEL_MINOR)) || ((RHEL_MAJOR <= 5) && (RHEL_MINOR < 6)) )
struct napi_struct {
