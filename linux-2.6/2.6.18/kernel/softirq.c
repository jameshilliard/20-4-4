...
#ifdef CONFIG_TIVO
extern void *last_irq_handler[2];
#endif
 ...
 */
#define CONFIG_TIVO_IRQ_REDZONE        64
 ...
 *
 */
extern void softirq_redzone_trampoline(struct softirq_action *, void *);
 
/* And the slightly modified asm version: */
asm(
"	.globl	softsoftirq_redzone_trampoline;\n"
"	.ent	softirq_redzone_trampoline;\n"
"	.type	softirq_redzone_trampoline, @function;\n"
"softirq_redzone_trampoline:"
...
"	.set	macro;\n"
"	.set	reorder;\n"
"	.end	softirq_redzone_trampoline;\n" 
);
...
#ifdef CONFIG_TIVO
	last_irq_handler[cpu] = h->action;
#endif

	softirq_redzone_trampoline(h, h->action);
