...
typedef void (*MBOX_RESET_FUNC)(int, void*);

#define MBOX_RESET_L_MAX			2048

typedef struct _tag_MBOX_ResetEntry
{
   struct list_head entry; 
   MBOX_RESET_FUNC  mbox_reset_func;
   void             *user_data;

} MBOX_ResetEntry;

typedef struct _tag_MBOX_ResetList
{
   MBOX_ResetEntry    resetEntries[MBOX_RESET_L_MAX];
