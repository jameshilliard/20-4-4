...
#ifdef CONFIG_TIVO
// remember nmi across reboot, for platforms that support it
void __weak note_nmi(void) { }
#endif
...
void __noreturn nmi_exception_handler(struct pt_regs *regs)
{
	...
	printk("NMI taken!!!!\n");
#ifdef CONFIG_TIVO
	printk("ErrorEPC = %08lx %pS CPU %d\n",
		read_c0_errorepc(), (void *)read_c0_errorepc(),
		smp_processor_id());
	note_nmi();
#endif
	die("NMI", regs);
