 ...
 *********************************************************************
 *
 *  File        :  $Source: /export/storage0/sources/cvsroot/Thirdparty/siliconvendor/broadcom/nexus/kernel/stblinux-2.6.37/include/linux/pace_serial_tt.h,v $
 *
...
*/
#define S_TT_DRV_VERSION   "$Revision: 1.2.14.1 $"
