...
static tree handle_no_instrument_function_attribute (tree *, tree,
						     tree, int, bool *);
#ifdef TIVO
static tree handle_no_tivo_audits_attribute (tree *, tree, tree, int,
                                             bool *);
#endif
...
#ifdef TIVO
  { "no_tivo_audits",         0, 0, true,  false, false,
			      handle_no_tivo_audits_attribute },
...
#ifdef TIVO
/* Handle a "no_tivo_audits" attribute.  */
static tree
handle_no_tivo_audits_attribute (tree *node, tree name,
                                 tree ARG_UNUSED (args),
                                 int ARG_UNUSED (flags),
                                 bool *no_add_attrs)
{
