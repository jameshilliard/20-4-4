...
void board_pinmux_setup(void)
{
	...
	/* The 7425 RGMII interface is connected to the Realtek Ethernet switch on D364.
	   Set the default external PHY mode to RGMII to indicate this */
	brcm_ext_mii_mode = BRCM_PHY_TYPE_EXT_RGMII;
...
int __init board_get_partition_map(struct mtd_partition **p)
{
	...
	/* Below is the setup for XG1, this will get overridden */
