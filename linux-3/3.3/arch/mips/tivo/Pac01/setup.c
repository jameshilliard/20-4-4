...
char *platform_whitelist[] __initdata = { "root=", "dsscon=", "brev=", "runfactorydiag=", "remaster=", "brcmgenet.macaddr_eth=", "brcmgenet.macaddr_moca=", "bcmvenet.macaddr=", "PROM_TYPE=", "mtdparts=", "ubi.mtd=", "parallel_boot", NULL };
...
int __init tivo_init(void)
{
    ...
    if (boardID < kTivoConfigBoardIDPaceBase || boardID > kTivoConfigBoardIDPaceMax)
    {
        ...
        boardID = kTivoConfigBoardIDPaceBase;
    }   
