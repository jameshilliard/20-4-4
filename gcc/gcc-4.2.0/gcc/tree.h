...
#ifdef TIVO
/* Used in FUNCTION_DECLs to indicate that function should not be
   considered for TiVo audits.  */
#define DECL_NO_TIVO_AUDITS(NODE) \
  (FUNCTION_DECL_CHECK (NODE)->function_decl.no_tivo_audits)
#endif
