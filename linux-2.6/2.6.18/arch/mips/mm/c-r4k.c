...
enum flush_routine
{
    f_bcm_local_inv_rac_all,           /* 0 */
    f_local_r4k_flush_cache_all,       /* 1 */
    f_local_r4k_flush_cache_range,     /* 2 */
    f_brcm_r4k_flush_cache_range,      /* 3 */
    f_local_r4k_flush_cache_mm,        /* 4 */
    f_local_r4k_flush_cache_page,      /* 5 */
    f_local_r4k_flush_icache_range,    /* 6 */
    f_local_r4k_flush_icache_page,     /* 7 */
    f_local_r4k_flush_cache_sigtramp,  /* 8 */
    f_r4k_flush_dcache_all,            /* 9 */
    f_r4k_flush_icache_all,            /* 10 */
    f_local_r4k_flush_data_cache_page, /* 11 */
    f_local_r4k___flush_cache_all      /* 12 */
};
...
#define TIVO_PLOG_FLUSH_CACHE(routine) \
    plog_flush_cache(routine, (unsigned long) __builtin_return_address(0))
#define TIVO_PLOG_DMA_COH(coh, addr, size) \
    plog_dma_coh(coh, addr, size, (unsigned long) __builtin_return_address(0))
#endif
...
{
#ifdef CONFIG_TIVO_PLOG
    TIVO_PLOG_FLUSH_CACHE(f_bcm_local_inv_rac_all);
#endif
...
{
#ifdef CONFIG_TIVO_PLOG
    TIVO_PLOG_FLUSH_CACHE(f_local_r4k_flush_cache_all);
#endif
	r4k_blast_dcache();
	r4k_blast_icache();
...
{
#ifdef CONFIG_TIVO_PLOG
    TIVO_PLOG_FLUSH_CACHE(f_local_r4k___flush_cache_all);
#endif
	CACHE_ENTER(all);
	r4k_blast_dcache();
	r4k_blast_icache();
...
static inline void local_r4k_flush_cache_range(void * args)
{
	...
	int exec;
#ifdef CONFIG_TIVO_PLOG
    TIVO_PLOG_FLUSH_CACHE(f_local_r4k_flush_cache_range);
#endif
	CACHE_ENTER(range);
...
void brcm_r4k_flush_cache_range(struct vm_area_struct *vma, unsigned long start, unsigned long end)
{
	...
	unsigned long flags;
#ifdef CONFIG_TIVO_PLOG
    TIVO_PLOG_FLUSH_CACHE(f_brcm_r4k_flush_cache_range);
#endif
	CACHE_ENTER(brange);
...
#ifdef CONFIG_TIVO_PLOG
    TIVO_PLOG_FLUSH_CACHE(f_local_r4k_flush_cache_mm);
#endif
...
static inline void local_r4k_flush_cache_page(void *args)
{
	...
	pte_t *ptep;
#ifdef CONFIG_TIVO_PLOG
    TIVO_PLOG_FLUSH_CACHE(f_local_r4k_flush_cache_page);
#endif
...
static inline void local_r4k_flush_data_cache_page(void * addr)
{
	CACHE_ENTER(dpage);
#ifdef CONFIG_TIVO_PLOG
    TIVO_PLOG_FLUSH_CACHE(f_local_r4k_flush_data_cache_page);
#endif
...
#ifdef CONFIG_TIVO_PLOG
    TIVO_PLOG_FLUSH_CACHE(f_local_r4k_flush_icache_range);
#endif
...
#ifdef CONFIG_TIVO_PLOG
    TIVO_PLOG_FLUSH_CACHE(f_local_r4k_flush_icache_page);
#endif
	CACHE_ENTER(ipage);
...
{
#ifdef CONFIG_TIVO_PLOG
	TIVO_PLOG_DMA_COH(f_r4k_dma_cache_wback_inv, addr, size);
#endif
	CACHE_ENTER(dmawb);
...
{
#ifdef CONFIG_TIVO_PLOG
	TIVO_PLOG_DMA_COH(f_r4k_dma_cache_inv, addr, size);
#endif
	CACHE_ENTER(dmainv);
	/* Catch bad driver code */
	BUG_ON(size == 0);
...
#ifdef CONFIG_TIVO_PLOG
    TIVO_PLOG_FLUSH_CACHE(f_local_r4k_flush_cache_sigtramp);
#endif
...
{
#ifdef CONFIG_TIVO_PLOG
    TIVO_PLOG_FLUSH_CACHE(f_r4k_flush_icache_all);
#endif
	CACHE_ENTER(iflush);
...
{
#ifdef CONFIG_TIVO_PLOG
    TIVO_PLOG_FLUSH_CACHE(f_r4k_flush_dcache_all);
#endif
	CACHE_ENTER(dflush);
        r4k_blast_dcache();
	CACHE_EXIT(dflush);
...
#ifdef CONFIG_TIVO
void tivo_r4k_flush_cache_wrapper(char routine)
{
    switch (routine) {
    case '0':
        bcm_inv_rac_all();
    ...
    case '1':
        ...
        break;
    case '4':
        r4k_flush_cache_mm(current->mm);
        break;
    case '9':
        r4k_flush_dcache_all();
        break;
    case 'A':
...
EXPORT_SYMBOL(tivo_r4k_flush_cache_wrapper);
#endif
