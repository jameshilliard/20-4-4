 ...
 ***************************************************************************/
#define BCHP_PCIE_0_MISC_RESET_CTRL              0x00464000 /* Reset Control Register */
#define BCHP_PCIE_0_MISC_ECO_CTRL_CORE           0x00464004 /* ECO Core Reset Control Register */
#define BCHP_PCIE_0_MISC_MISC_CTRL               0x00464008 /* MISC Control Register */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN0_LO  0x0046400c /* CPU to PCIe Memory Window 0 Low */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN0_HI  0x00464010 /* CPU to PCIe Memory Window 0 High */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN1_LO  0x00464014 /* CPU to PCIe Memory Window 1 Low */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN1_HI  0x00464018 /* CPU to PCIe Memory Window 1 High */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN2_LO  0x0046401c /* CPU to PCIe Memory Window 2 Low */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN2_HI  0x00464020 /* CPU to PCIe Memory Window 2 High */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN3_LO  0x00464024 /* CPU to PCIe Memory Window 3 Low */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN3_HI  0x00464028 /* CPU to PCIe Memory Window 3 High */
#define BCHP_PCIE_0_MISC_RC_BAR1_CONFIG_LO       0x0046402c /* RC BAR1 Configuration Low Register */
#define BCHP_PCIE_0_MISC_RC_BAR1_CONFIG_HI       0x00464030 /* RC BAR1 Configuration High Register */
#define BCHP_PCIE_0_MISC_RC_BAR2_CONFIG_LO       0x00464034 /* RC BAR2 Configuration Low Register */
#define BCHP_PCIE_0_MISC_RC_BAR2_CONFIG_HI       0x00464038 /* RC BAR2 Configuration High Register */
#define BCHP_PCIE_0_MISC_RC_BAR3_CONFIG_LO       0x0046403c /* RC BAR3 Configuration Low Register */
#define BCHP_PCIE_0_MISC_RC_BAR3_CONFIG_HI       0x00464040 /* RC BAR3 Configuration High Register */
#define BCHP_PCIE_0_MISC_MSI_BAR_CONFIG_LO       0x00464044 /* Message Signaled Interrupt Base Address Low Register */
#define BCHP_PCIE_0_MISC_MSI_BAR_CONFIG_HI       0x00464048 /* Message Signaled Interrupt Base Address High Register */
#define BCHP_PCIE_0_MISC_MSI_DATA_CONFIG         0x0046404c /* Message Signaled Interrupt Data Configuration Register */
#define BCHP_PCIE_0_MISC_RC_BAD_ADDRESS_LO       0x00464050 /* RC Bad Address Register Low */
#define BCHP_PCIE_0_MISC_RC_BAD_ADDRESS_HI       0x00464054 /* RC Bad Address Register High */
#define BCHP_PCIE_0_MISC_RC_BAD_DATA             0x00464058 /* RC Bad Data Register */
#define BCHP_PCIE_0_MISC_RC_CONFIG_RETRY_TIMEOUT 0x0046405c /* RC Configuration Retry Timeout Register */
#define BCHP_PCIE_0_MISC_EOI_CTRL                0x00464060 /* End of Interrupt Control Register */
#define BCHP_PCIE_0_MISC_PCIE_CTRL               0x00464064 /* PCIe Control */
#define BCHP_PCIE_0_MISC_PCIE_STATUS             0x00464068 /* PCIe Status */
#define BCHP_PCIE_0_MISC_REVISION                0x0046406c /* PCIe Revision */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN0_BASE_LIMIT 0x00464070 /* CPU to PCIe Memory Window 0 base/limit */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN1_BASE_LIMIT 0x00464074 /* CPU to PCIe Memory Window 1 base/limit */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN2_BASE_LIMIT 0x00464078 /* CPU to PCIe Memory Window 2 base/limit */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN3_BASE_LIMIT 0x0046407c /* CPU to PCIe Memory Window 3 base/limit */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN0_BASE_HI 0x00464080 /* CPU to PCIe Memory Window 0 base high */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN0_LIMIT_HI 0x00464084 /* CPU to PCIe Memory Window 0 limit high */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN1_BASE_HI 0x00464088 /* CPU to PCIe Memory Window 1 base high */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN1_LIMIT_HI 0x0046408c /* CPU to PCIe Memory Window 1 limit high */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN2_BASE_HI 0x00464090 /* CPU to PCIe Memory Window 2 base high */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN2_LIMIT_HI 0x00464094 /* CPU to PCIe Memory Window 2 limit high */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN3_BASE_HI 0x00464098 /* CPU to PCIe Memory Window 3 base high */
#define BCHP_PCIE_0_MISC_CPU_2_PCIE_MEM_WIN3_LIMIT_HI 0x0046409c /* CPU to PCIe Memory Window 3 limit high */
#define BCHP_PCIE_0_MISC_MISC_CTRL_1             0x004640a0 /* MISC Control Register 1 */
#define BCHP_PCIE_0_MISC_UBUS_CTRL               0x004640a4 /* UBUS Control */
#define BCHP_PCIE_0_MISC_UBUS_TIMEOUT            0x004640a8 /* UBUS Timeout */
#define BCHP_PCIE_0_MISC_UBUS_BAR1_CONFIG_REMAP  0x004640ac /* UBUS BAR1 System Bus Address Remap Register */
#define BCHP_PCIE_0_MISC_UBUS_BAR1_CONFIG_REMAP_HI 0x004640b0 /* UBUS BAR2 System Bus Address Remap Register High */
#define BCHP_PCIE_0_MISC_UBUS_BAR2_CONFIG_REMAP  0x004640b4 /* UBUS BAR2 System Bus Address Remap Register */
#define BCHP_PCIE_0_MISC_UBUS_BAR2_CONFIG_REMAP_HI 0x004640b8 /* UBUS BAR2 System Bus Address Remap Register High */
#define BCHP_PCIE_0_MISC_UBUS_BAR3_CONFIG_REMAP  0x004640bc /* UBUS BAR3 System Bus Address Remap Register */
#define BCHP_PCIE_0_MISC_UBUS_BAR3_CONFIG_REMAP_HI 0x004640c0 /* UBUS BAR3 System Bus Address Remap Register High */
#define BCHP_PCIE_0_MISC_UBUS_STATUS             0x004640c4 /* UBUS Status */
...
/* PCIE_0_MISC :: MISC_CTRL :: TBD_OPTION_19 [19:19] */
#define BCHP_PCIE_0_MISC_MISC_CTRL_TBD_OPTION_19_MASK              0x00080000
#define BCHP_PCIE_0_MISC_MISC_CTRL_TBD_OPTION_19_SHIFT             19
#define BCHP_PCIE_0_MISC_MISC_CTRL_TBD_OPTION_19_DEFAULT           0x00000000
